...
public class CustomerGUI extends JFrame {
    ...
    public CustomerGUI() {
        ...
        manageAccountButton.addActionListener(this::manageAccountAction);
        ...
        manageButtonsPanel.add(manageAccountButton);
        ...
        resultArea.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                try {
                    ...
                    if (flightNumber != null && destination != null && departureLocation != null && aircraftID != null && aircraftType != null && totalSeats != null && departureDateStr != null && departureTimeStr != null) {
                        // Create Date object
    ...
    private void manageAccountAction(ActionEvent event) {
        // Perform actions when the "Manage Account" button is clicked
        // Create a new instance of ManageAccountGUI
        AccountGUI manageAccountGUI = new AccountGUI();
        // Display the ManageAccountGUI
        manageAccountGUI.display();
    }
